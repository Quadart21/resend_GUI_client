...
<template>
  <div class="overflow-hidden rounded-xl border border-border bg-surface-elevated ring-1 ring-white/[0.03]">
...
<style scoped>
.toolbar-btn {
  @apply rounded-lg px-2.5 py-1 text-xs text-muted transition hover:bg-surface-hover hover:text-zinc-100;
}
